...
class blogFilter_options {
  ...
  */
  public function create_admin_menu_page() {
    $this->plugin_options_page = add_options_page('blogFilter', 'blogFilter', 'manage_options', __FILE__, array( $this, 'render_plugin_options_page' ) );
  }

  public function render_plugin_options_page() {
    echo '<div id="blogFilter"></div>';
  }
...
$blogFilter_options = new blogFilter_options();
$blogFilter_options->init();